...
export const initialBooksData = [
  {
    ...
    genre: 'Біографія',
    parts: [
      { id: 'part1', name: 'Перша частина', availableQuantity: 7 },
      { id: 'part2', name: 'Друга частина', availableQuantity: 15 },
    ]
  },
  {
    id: 2,
    ...
    genre: 'Реалізм',
    parts: [
      { id: 'part1', name: 'Перша частина', availableQuantity: 12 },
      { id: 'part2', name: 'Друга частина', availableQuantity: 11 },
    ]
  },
  {
    id: 3,
    ...
    parts: [
      { id: 'part1', name: 'Перша частина', availableQuantity: 10 },
      { id: 'part2', name: 'Друга частина', availableQuantity: 15 },
    ]
  },
  {
    ...
    genre: 'Саморозвиток',
    parts: [
      { id: 'part1', name: 'Перша частина', availableQuantity: 9 },
      { id: 'part2', name: 'Друга частина', availableQuantity: 14 },
    ]
  },
  {
    id: 5,
    ...
    genre: 'Саморозвиток',
    parts: [
      { id: 'part1', name: 'Перша частина', availableQuantity: 11 },
      { id: 'part2', name: 'Друга частина', availableQuantity: 13 },
    ]
  },
];
